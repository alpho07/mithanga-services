            ...
            <div class="card">
                            ...
                            <table class="table table-bordered" style="width:1000px !important;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="" style="text-align: right;">{{str_replace('-','',number_format($b->balance,2)) }}</td>                                      
                                    </tr>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td></td>
                        <td><strong>TOTALS</strong></td>
                        <td style="text-align: right; font-weight: bold;font-size: 20px;"><strong>{{str_replace('-','',number_format($bal,2)) }}</strong></td>
                    </tr>
                </table>
            </div>
        </div>
